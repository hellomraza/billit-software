...
export function InsufficientStockModal({
  ...
  const handleResolve = () => {
    ...
    const sellingProducts = items.filter(
      (item) => resolutions[item.product.id] !== "remove",
    ).length;
    announceAction(
      `Stock conflict resolved. ${sellingProducts} items will be processed.`,
    );
    onResolve(formatted);
  };
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    >
                      {currentResolution === "sell-anyway" ? "✓ " : ""}Sell
                      Anyway
                    </Button>
                    <Button
                      variant={
                      ...
                      className="text-xs h-9"
                      onClick={() =>
                        updateResolution(item.product.id, "remove")
                      }
          ...
          <DialogFooter className="mt-4 pt-4 border-t">
            ...
            <Button
              ...
              title={
                cartWillBeEmpty ? "Cannot proceed - all items removed" : ""
              }
            >
              Apply & Continue
            </Button>
