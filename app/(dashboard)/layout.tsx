  ...
  return (
    <ErrorBoundary>
      <OutletBootstrap>
        <SidebarProvider>
          <UiSidebar />
          <SidebarInset className="md:max-w-[calc(100vw-16rem)] md:peer-data-[state=collapsed]:max-w-[calc(100vw-var(--sidebar-width-icon))] transition-all duration-200 ease-linear">
